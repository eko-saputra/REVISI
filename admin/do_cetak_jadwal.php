...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 7, 'JADWAL TANDING SEMIFINAL PENCAK SILAT KOTA DUMAI', 0, 1, 'C');
        ...
        $this->Cell(98, 8, 'Sudut Biru', 1, 0, 'C', true);
        // $this->Cell(35, 8, 'Kontingen Biru', 1, 0, 'C', true);

        // Lalu Sudut Merah (dipindah)
        $this->SetFillColor(255, 0, 0);
        $this->Cell(98, 8, 'Sudut Merah', 1, 0, 'C', true);
        // $this->Cell(39, 8, 'Kontingen Merah', 1, 0, 'C', true);

        // Grup
        $this->SetFillColor(255, 255, 0);
        $this->SetTextColor(0);
        $this->Cell(25, 8, 'Grup', 1, 1, 'C', true);
    }
}

// ✅ Query dinamis
$sqljadwal = "SELECT * FROM jadwal_tanding WHERE 1=1";
