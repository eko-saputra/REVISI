...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form name="InputPeserta" id="InputPeserta" method="POST" enctype="multipart/form-data" action="do_pendaftaran_tanding.php" class="registration-form">
          ...
          <div class="form-group row mb-3">
            <label for="kelas_tanding" class="col-sm-3 col-form-label form-label">Kelas Tanding</label>
            <div class="col-sm-9">
              <div class="input-group">
                <select name="kelas_tanding" id="kelas_tanding" class="form-select">
                  <?php while($kelastanding = mysqli_fetch_array($carikelas)) { ?>
                  <option value="<?php echo $kelastanding[0]; ?>"><?php echo $kelastanding[1]; ?></option>
                  <?php } ?>
                </select>
                <a href="tabel_kelas_tanding.php" target="_blank" class="btn btn-outline-secondary">Detail Tabel</a>
              </div>
            </div>
          </div>
